...
print(x1)
plt.plot(x1,y1,'r',label = 'yuqici')
plt.title("yuqici frequancy of yukongchuan")
plt.xlabel('yuqucis')
plt.ylabel('frequancy')
plt.savefig("yuqici frequancy of yukongchuan.png")
plt.close()
...
print(x2)
plt.plot(x2,y2,'r',label = 'yuqici')
plt.title("yuqici frequancy of xiyouji")
plt.xlabel('yuqucis')
plt.ylabel('frequancy')
plt.savefig("yuqici frequancy of xiyouji.png")
plt.close()
