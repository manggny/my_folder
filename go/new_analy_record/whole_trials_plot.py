...
if __name__=="__main__":
	...
	plt.fill_between(x1, all_odor1_hit_mean - all_odor1_hit_error, all_odor1_hit_mean + all_odor1_hit_error, alpha=0.3,
					 color='r')
	...
	plt.fill_between(x1, all_odor2_cr_mean - all_odor2_cr_error, all_odor2_cr_mean + all_odor2_cr_error, alpha=0.3,
					 color='y')
	plt.plot(x1, all_odor2_hit_mean, 'g', label='odor2_fa') #[0:125]
