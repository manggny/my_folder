...
if __name__ == '__main__':
	...
	for names in filelist_current:
		...
		if names == 'go_nogo_result_noact.xls':
			exist = 1
			break;
	if exist == 0:
		...
		book.save('go_nogo_result_noact.xls')

	for raw_file in filelist:
		if raw_file == 'go_nogo_result_noact.xls':
			continue
		oldwb = xlrd.open_workbook('go_nogo_result_noact.xls')
		newwb = copy(oldwb)
	...
	#	print(noact_trial)
		...
		if saved == 0:
			...
			os.remove('go_nogo_result_noact.xls')
			newwb.save('go_nogo_result_noact.xls')
